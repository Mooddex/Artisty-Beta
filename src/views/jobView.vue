...
const handleDelete = async () =>{
   try {
    ...
    //toast success
    toast.success('job deleted good')
    router.push(`/jobs`)
    }
} catch (error) {
...
<template>
      ...
      <div class="grid grid-cols-1 md:grid-cols-70/30 w-full gap-6">
        <main>
          ...
          >
            ...
            >
              <i
                class="pi pi-solid pi-map-marker text-xl text-orange-700 mr-2"
              ></i>
  ...
  <!-- loading -->
  <div v-else class="text-center text-gray-600 py-6"><PulseLoader /></div>
</template>
